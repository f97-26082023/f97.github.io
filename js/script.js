...
document.ready(
    ...
    () => {
        ...
        // default dark if system is dark
        ...
        _Blog.toggleTheme();
        // ready function.
        // Auto line-through for input checked
        let inputs = document.querySelectorAll('.post-content input');
        for (index = 0; index < inputs.length; ++index) {
            if(inputs[index].checked){
                inputs[index].parentNode.style.textDecoration = 'line-through';
            }
        }
    }
);